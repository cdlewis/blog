...
This scoring approach worked well enough. Simpler functions (i.e., those with lower scores) are more likely to match, and matching them early builds momentum and context for later attempts.
...
The 'give up after ten attempts' threshold matters. Without it, Claude will happily burn many attempts on an impossible function. With this safeguard in place, the process terminates early and proceeds to a more tractable function.
...
_If you've made it this far, you probably have an interest in decompilation and Snowboard Kids. Give it a try. Take a look at `difficult_functions.txt` on the [Snowboard Kids 2 decomp GitHub page](https://github.com/cdlewis/snowboardkids2-decomp) and see if you can beat the LLMs!_
